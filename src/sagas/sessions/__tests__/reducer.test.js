...
describe('sagas/sessions/reducer.js', () => {
  ...
  describe('CREATE_SESSION', () => {
    it('returns pending state', () => {
      ...
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.CREATE_SESSION}`, updateRequest(PENDING, null));
    ...
    it('returns success state', () => {
      ...
      produce(getInitialState(), draft => {
        ...
        _.set(draft, `requests.${actions.CREATE_SESSION}`, updateRequest(SUCCESS, null));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns failed state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.CREATE_SESSION}`, updateRequest(FAILED, error));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns aborted state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.CREATE_SESSION}`, updateRequest(ABORTED, null));
        expect(actual).toEqual(draft);
      });
    });
  });
  ...
  describe('GET_SESSIONS', () => {
    it('returns pending state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.GET_SESSIONS}`, updateRequest(PENDING, null));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns success state', () => {
      ...
      produce(getInitialState(), draft => {
        ...
        _.set(draft, `requests.${actions.GET_SESSIONS}`, updateRequest(SUCCESS, null));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns failed state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.GET_SESSIONS}`, updateRequest(FAILED, error));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns aborted state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.GET_SESSIONS}`, updateRequest(ABORTED, null));
        expect(actual).toEqual(draft);
      });
    });
  });
  ...
  describe('GET_SESSION_TYPES', () => {
    it('returns pending state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.GET_SESSION_TYPES}`, updateRequest(PENDING, null));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns success state', () => {
      ...
      produce(getInitialState(), draft => {
        ...
        _.set(draft, `requests.${actions.GET_SESSION_TYPES}`, updateRequest(SUCCESS, null));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns failed state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.GET_SESSION_TYPES}`, updateRequest(FAILED, error));
        expect(actual).toEqual(draft);
      });
    });
    ...
    it('returns aborted state', () => {
      ...
      const actual = reducer(undefined, action);
      produce(getInitialState(), draft => {
        _.set(draft, `requests.${actions.GET_SESSION_TYPES}`, updateRequest(ABORTED, null));
        expect(actual).toEqual(draft);
      });
    });
  });
